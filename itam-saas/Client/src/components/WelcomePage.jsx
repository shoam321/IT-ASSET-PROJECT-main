          ...
          <form onSubmit={handleEmailSubmit} className="max-w-md mx-auto mb-6 sm:mb-8 px-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 group"
              >
                Start Free Trial
                <ArrowRight className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform ${isHovering ? 'translate-x-1' : ''}`} />
              </button>
            </div>
          </form>
